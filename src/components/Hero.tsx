      ...
      <div className="max-w-3xl text-center">
        ...
        >
          ...
          <a
            ...
            className="px-8 py-3 border border-outline text-outline-text rounded-lg text-sm font-medium hover:border-bdr-h hover:text-heading transition-all inline-flex items-center gap-2"
          >
