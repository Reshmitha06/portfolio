  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-3xl text-center">
        ...
        >
          Hi, I&apos;m{" "}
          <span className="text-gray-500">Reshmitha</span>
        </motion.h1>
        ...
        >
          ...
          <a
            href="#contact"
            className="px-8 py-3 border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:border-gray-400 transition-colors"
          >
            Get In Touch
          </a>
        </motion.div>
        ...
        >
          <a
            href="https://github.com/Reshmitha06"
            target="_blank"
          ...
          <a
            href="https://linkedin.com/in/chaikam-reshmitha-reddy-75b486263"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-gray-700 transition-colors"
            aria-label="LinkedIn"
          ...
          <a
            href="mailto:reshmithareddychaikam@gmail.com"
            className="text-gray-400 hover:text-gray-700 transition-colors"
            aria-label="Email"
          >
